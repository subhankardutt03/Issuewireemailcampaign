...
const UpdateCampaign = () => {
    ...
    useEffect(() => {
        fetch('http://emailcampaign.frontpews.com/emailcampaign/public/api/campaign/' + params.id)
            .then(res => {
                return res.json();
            })
            .then(data => {
...
// console.log(campaign_options)
    ...
    //     getData();
        ...
        async function getData() {
            const response1 = await fetch("http://emailcampaign.frontpews.com/emailcampaign/public/api/template")
            ...
            const response3 = await fetch("http://emailcampaign.frontpews.com/emailcampaign/public/api/emailqueue");
    ...
    function smtpsubmit(e) {
        ...
        if (Object.keys(formErrors).length === 0) {
            ...
            axios({
                method: 'put',
                url: 'http://emailcampaign.frontpews.com/public/emailcampaign/api/campaign/' + params.id,
                data: {
